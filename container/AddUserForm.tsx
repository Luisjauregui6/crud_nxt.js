...
const AddUserForm = () => {
    ...
    const validationSchema = Yup.object({
        firstName: Yup.string().required("favor de rellenar todos los campos"),
        lastName: Yup.string().required("favor de rellenar todos los campos"),
        email: Yup.string().required("favor de rellenar todos los campos").email("email invalido")
    })
